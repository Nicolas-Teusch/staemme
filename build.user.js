...
(function () {
    ...
    function getNextBuild(currentBuildLevel) {
        ...
        //market
        if ((getSanitisedCurrentLevel(currentBuildLevel, ids.market) == 20 || getBuildDistance(ids.iron, ids.market) > 15) && buildRequirementSatisfied(ids.market, currentBuildLevel) && !isCurrentlyBuilding(ids.market, currentBuildLevel) && currentBuildLevel.market.currentLevel < maxMarketBuildLevel)
            return ids.market
